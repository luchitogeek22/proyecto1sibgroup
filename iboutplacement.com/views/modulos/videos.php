    ...
    <div class="container text-center wow animate__ animate__fadeInUp  animated" data-wow-duration="3s"
        ...
        <div class="row">
            <div class=" container_video col-md-6">
                <h3 style="font-size: 20px;">OUTPLACEMENT EL MEJOR EMPLEO EN EL MENOR TIEMPO POSIBLE</h3>
            ...
            <div class="col-md-6">
                <h3 style="font-size: 19px;">COACHING OPTIMIZA LA BÚSQUEDA DE EMPLEO Y DESARROLLA HABILIDADES BLANDAS
                </h3>
