...
if (isset($_POST["nombrecompleto-outplacement"])) {
    $nombrecompleto = $_POST["nombrecompleto-outplacement"];
} else {
    $nombrecompleto = null;
};
if (isset($_POST["correo-outplacement"])) {
    $correo = $_POST["correo-outplacement"];
} else {
    $correo = null;
};
if (isset($_POST["telefono-outplacement"])) {
    $telefono = $_POST["telefono-outplacement"];
} else {
    $telefono = null;
};

$fecha = '<strong>Fecha: </strong>' . DateGet();
$subject = 'VIDEO OUTPLACEMENT';
